...
ellipsoid_points_shape ellipsoid_saucer::shape=ellipsoid_points_shape(0.3,10,1,10);
...
void World3DThread::Build(basis* b)
{
 ...
 Objects[3]=new ellipsoid_saucer(0.1,basis(location(-20,-20, 100)),0x7f7f7f,10,((Sun*)Objects[0])->jupiter());
 ...
 for (int i=0; i<stars_count; i++) {
     ...
     _ort[1]/=4;
     stars[i] = new star(Planet_absolute_mass(Sun_mass),basis((rand()%30000000+1500000)*_ort),colors[rand()%5],(Sun_size)*(rand()%10 + 1)/2.0,rand()%10,0.1);
